...
export default function Profile() {
  ...
  return (
    <div className="enterprise-profile-page">
      ...
      {/* The old token-based "Минисайт" section (invite link + avatar + portfolio)
          was removed: it served the deprecated /m/<token> minisite. The new
          slug-based Минилендинг lives on its own tab in the bottom nav and
          owns all visual editing (hero photo, name, services, advantages, …). */}
